...
Pod::Spec.new do |s|
  s.name             = 'Bongloy'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Bongloy.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Khom Sovon/Bongloy'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Khom Sovon' => 'khom.sovon@gmail.com' }
  s.source           = { :git => 'https://github.com/Khom Sovon/Bongloy.git', :tag => s.version.to_s }
